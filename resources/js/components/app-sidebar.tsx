            ...
            <div className="fixed bottom-0 z-20 w-full overflow-hidden bg-transparent lg:hidden">
                <div className="relative z-0 w-full">
                    <div
                        ...
                        className="aboslute top-0 left-0 z-20 h-[160px] sm:h-[200px] md:h-[260px] overflow-hidden bg-cover bg-top bg-no-repeat"
                    >
                        ...
                        <div className="fixed bottom-4 md:bottom-7 w-full px-8">
                            <div className="flex items-center justify-between">
                                {MOBILE_NAV_ITEMS.map((item, index) => {
                                    const isActive = activeName === item.name;
                                    const isMiddle = index === 2;
                                    ...
                                    return (
                                        <Link
                                            ...
                                            href={item.href}
                                            onClick={() => setActivePath(item.href)}
                                            className={`flex items-center justify-center rounded-full transition-all duration-300 ${isMiddle ? '-mt-10 md:-mt-24 h-20 w-20 border bg-secondaryWhite shadow-[inset_0_4px_6px_rgba(0,0,0,0.5)]' : 'h-14 w-14'} ${isActive ? 'bg-[#27E6A7] shadow-[inset_0_4px_6px_rgba(0,0,0,0.3)]' : ''} `}
                                            aria-current={isActive ? 'page' : undefined}
                                        >
                                            <img
                                                src={isActive ? item.activeIcon : item.icon}
                                                alt={item.name}
                                                className={`object-contain transition-all ${isMiddle ? 'h-10 w-10 md:w-13 md:h-13' : 'md:w-10 md:h-10 h-8 w-8'} `}
                                            />
                                        </Link>
                                    );
                                })}
