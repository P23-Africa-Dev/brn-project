...
const UserMobileCard: React.FC<UserCardProps> = ({ name, location, title, industry, rating, imageSrc }) => {
    return (
        <div className="relative flex items-center space-x-4 border-b-3 bg-transparent p-4">
          
            <div className="relative  h-[100px] w-[100px] overflow-hidden rounded-l-xl bg-transparent">
