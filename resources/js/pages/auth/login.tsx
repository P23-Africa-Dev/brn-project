        ...
        >
            <div className="w-full border p-8 lg:overflow-y-auto">
                <div className="relative z-10 mx-auto max-w-md">
                    <div className="mb-10">
                        <h2 className="mb-1 text-2xl font-extrabold text-primary lg:text-3xl dark:text-black">Your Next Connection Awaits You!</h2>
                    ...
                    <div className="max-w-sm">
                        <form onSubmit={submit} className="space-y-7">
                            ...
                            <div className="flex items-center justify-between px-2 text-sm font-medium text-primary">
                                <label className="flex cursor-pointer items-center gap-2 dark:text-black">
                                    <Checkbox
                                        id="remember"
                                        name="remember"
                                ...
                                {canResetPassword && (
                                    <TextLink href={route('password.request')} className="font-semibold text-primary italic dark:text-black">
                                        Forgot Password
                                    </TextLink>
                                )}
                            </div>
                            ...
                            <div className="mt-0 flex justify-center">
                                <p className="text-sm font-light text-primary dark:text-black">
                                    ...
                                    <TextLink
                                        tabIndex={5}
                                        href={'http://127.0.0.1:8080/brn-form'}
                                        className="font-bold text-primary italic dark:text-black"
                                    >
                                        Register Now
                                    </TextLink>
                                </p>
